...
export default function WhatsAppFloat() {
  return (
    <a
      href={waLink("Habari HZE! ☕")}
      target="_blank"
      rel="noreferrer"
      aria-label="Chat with Harakati za Enzi on WhatsApp"
      className="btn-press fixed bottom-5 right-5 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-hze-teal text-white shadow-lg hover:bg-[#236458] transition-colors motion-safe:animate-[wa-pulse_2.5s_ease-in-out_infinite]"
    >
