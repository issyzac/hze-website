...
/**
 * Share controls. Rendered twice — once at the head of the story and once at
 * its foot — so `place` keeps each button's accessible name unique.
 */
const ShareRow: React.FC<{ place: string }> = ({ place }) => {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      <a
        ...
        className={pill}
        style={pillStyle}
        aria-label={`Share Mirumbani on WhatsApp (${place})`}
      >
      ...
      <a
        ...
        className={pill}
        style={pillStyle}
        aria-label={`Share Mirumbani on X (${place})`}
      >
      ...
      <button
        ...
        className={pill}
        style={pillStyle}
        aria-label={`Copy link to Mirumbani (${place})`}
      >
